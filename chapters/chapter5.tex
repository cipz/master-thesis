...
pycom.heartbeat(False)
				...
				When set to \texttt{PLAIN\_RECEIVER}, the board will execute the code in the \texttt{plain\_receiver.py} file, which listens to the packets traveling in the air.
				Such process can be seen in FSA~\ref{fsa:boot_sequence}, described in Table~\ref{table:fsa_boot}
