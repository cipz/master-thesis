...
\chapter{Related work}\label{chapter:related_work}
	...
	\section{Scalability of WMS}\label{sec:scalability}
			...
			Each solution for scalability brings advantages and disadvantages.
			
			There are numerous factors that 
			
			This first part will be on fundamental limits (the governing “laws of physics” as it were), and the second part will focus on practical aspects and protocols.
		
			The number of nodes determines the usefulness of a mesh network.
			
			Scalability of Mobile Ad Hoc Networks: Theory vs practice \cite{5680385}
