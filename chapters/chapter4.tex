	...
	\section{Projects}\label{sec:chap4_projects}
		...
		\subsection{Research projects}
			...
			\subsection{LoRa mesh networks}
				...
				% Monitoring of Large-Area IoT Sensors Using LoRa Wireless Mesh Network System: Design and Evaluation
...
%			% https://ieeexplore.ieee.org/document/9394317
			\subsubsection{LoRaCTP}\label{subsec:loractp}
				...
				\begin{figure}[h]
					\centering
					\includegraphics[width=.65\textwidth]{resources/img/chap4/loractp_flow}
					...
					\label{img:flow_loractp}
				\end{figure}
		
				Authors have made the code publicly available online on a GitHub repository\footnote{ \url{www.github.com/pmanzoni/loractp}}.
				Section~\ref{sec:software_solution} explains how \texttt{loracpt.py} is used in Open LoRa Mesh in forwarding messages from one node to another.
		...
		\subsection{Commercial applications}\label{subsec:commercial_applications}
			...
			\subsubsection{Off grid mesh devices: Sonnet and goTenna}\label{subsec:sonnet}
