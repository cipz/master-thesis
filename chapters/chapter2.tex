...
\chapter{Background}\label{chapter:background}
	...
	\section{Internet of Things}
		...
		\subsection{Trends, forecasts and research directions}\label{sec:trends}
			...
			% \footnote{ ``\textit{Edge Computing does not mean computers at the edge of a table.}'' -cit. Alessandro Canesso} 
	...
	\section{Air quality sensing}
		...
		\subsection{ArduECO}\label{subsec:ardueco}
			...
			\begin{figure}[h]
				\centering
				\includegraphics[width=\textwidth]{resources/img/chap2/ardueco_circuit}
