...
%			Thus an interesting improvement could be to add a heatsink in order to lower the temperatures and improve the lifespan of the device
			...
			Another possible improvement could be to add a hard 3D printed shell to each node.
			If the MegaSense integration with Open LoRa Mesh is accepted as a
...
%			Aggiungere gestione delle eccezioni per i messaggi, come spiegato in subsec:loop
		...
		\subsection{On LoRa and other transmission methods}\label{sec:other_transmission_methods}
		
%			How other transmission methods would compare against lora in this use case
